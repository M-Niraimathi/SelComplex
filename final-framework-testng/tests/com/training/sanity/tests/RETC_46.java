...
import com.training.pom.Featreg;
...
public class RETC_46 {

	private WebDriver driver;
	private String baseUrl;
	private PropertyTab1 prop;
	private Feature feature;
	private Featreg feareg;
	...
	public void validLoginTest() throws InterruptedException, AWTException {
		...
		feature.clickChkbox();
		screenShot.captureScreenShot("addnewscr1");
		feareg.clickRegChkbox();
		Thread.sleep(2000);
		prop.clickPublish();
